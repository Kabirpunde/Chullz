...
export default function SelectProfile() {
  ...
  return (
    <div className="screen" style={{ background: '#060b14', overflowY: 'auto' }}>
      {/* Header */}
      <div style={{ textAlign: 'center', padding: '20px 16px 16px', flexShrink: 0 }}>
        <div style={{ fontSize: 22, color: '#00f0ff', letterSpacing: 8, marginBottom: 6 }}>♠ ♥ ♦ ♣</div>
        <div style={{ fontSize: 34, fontWeight: 900, color: '#ffb800', letterSpacing: 4 }}>CHULLZ</div>
        <div style={{ fontSize: 13, color: '#64748b', marginTop: 4 }}>Select your profile to enter</div>
      </div>
      ...
      <div style={{ 
        ...
        {PROFILES.map(p => (
          ...
          >
            ...
            <span style={{ fontSize: 14, fontWeight: 800, color: '#ffffff' }}>{p.username}</span>
            {(p as any).role === 'admin' ? (
              <span style={{
              ...
              <span style={{ fontSize: 11, color: '#64748b' }}>10,000 🪙</span>
            )}
          </button>
        ))}
      </div>
          ...
          >
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{ fontSize: 42 }}>{selected.avatar}</span>
              </div>
            </div>
            ...
            <div style={{ height: 18, marginBottom: 8, color: '#ef4444', fontSize: 12 }}>
              {error}
            </div>

            {/* Numpad */}
            {loading ? (
              <div style={{ padding: '28px 0', color: '#00f0ff', fontSize: 28 }}>⟳</div>
            ) : (
              <div style={{
